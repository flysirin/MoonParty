...
HOST_LEXICON: dict = {
    ...
    "Exception start lives": "Нельзя задать начальное количество жизней меньше 5",
    "Exception win lives": "Нельзя задать начальное количество жизней меньше 10",
    "Exception start lives more win": "Нельзя задать стартовое количество жизней больше либо равным победному",

    "Win lives:": "Победное количество жизней:",
    "Count winners:": "Количество победителей:",
    "Exception count winners": "Нельзя задать меньше 1 победителя",
    ""
    "Spread roles": "<i>1) Задайте свои параметры в процентах \n2) Сумма должна быть = 100%\n3) Подтвердите выбор</i>",
    "Exception spread role 90": "Нельзя задать значение больше 90 %",
    "Sum percent roles:": "Сумма:",
    "wolf": "волк",
    "human": "человек",
    "Exception spread role": "Сумма не равна 100%",
...
HOST_BUTTONS: dict = {
    ...
    "Win lives": "Победное количество жизней",
    "Count winners": "Количество победителей",
    "Spread roles": "%-людей / %-волков / %-оборотней",
    ...
    "+ human": "+ 10% люди",
    "- human": "- 10% люди",
    "+ werewolf": "+ 10% оборотни",
    "- werewolf": "- 10% оборотни",
    "Confirm this spread": "✅ Установить это распределение",

    # game process
    "Confirm finish game process": "✅ Подтвердить",
    "Update info": "📋 Обновить",
    "Finish game": "❌ Завершить игру",
    "Up / Down - lives": "👨‍👨‍👧‍👦 Добавить/отнять жизней",
    "lives:": "Жизни:",
    "Up lives": "+ 1 жизнь",
    "Down lives": "- 1 жизнь",
